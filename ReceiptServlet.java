...
//					String getChecked = req.getParameter(check1);
					if (bQty < quantity) {
						pw.println(
								"</table><div class=\"jitu\">Please Select the Qty less than Available Books Quantity</div>");
						break;
					}
//                                                  else if(!check1.equals("checked")){
//                                                     pw.println(
//								"</table><div class=\"jit\">Please Select the Book </div>");
//						break;
//                                                  }
