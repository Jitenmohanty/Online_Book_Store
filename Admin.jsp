<%-- 
    Document   : index
    Created on : 28 Jul, 2022, 11:12:24 AM
    Author     : o
--%>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
						...
						class="nav-link py-3 px-0 px-lg-3 rounded" href="AddBook.jsp">Add Books</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
                                                class="nav-link py-3 px-0 px-lg-3 rounded" href="removebook.jsp">Remove Book</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="AdminBooks.jsp">View Books</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
...
<!--						class="nav-link py-3 px-0 px-lg-3 rounded" href="#contact">Contact</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a-->
						<a class="nav-link py-3 px-0 px-lg-3 rounded bg-danger" href="logout">Logout</a></li>
						...
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<img class="img-fluid rounded mb-5"
									src="assets/img/portfolio/html css.jpg" alt="..." />
